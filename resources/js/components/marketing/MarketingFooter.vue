...
import { about, contact, home, howItWorks, pricing, privacy } from '@/routes';
        ...
        >
            <div class="max-w-md">
                ...
                <p class="mt-5 text-sm leading-7 text-slate-400">
                    Practical document automation for Ugandan businesses. Turn
                    invoices, receipts and other business documents into
            ...
            <div>
                <h2
                    class="text-sm font-bold tracking-wide text-white uppercase"
                >
                    Explore
                </h2>
                <nav
                ...
                >
                    <Link :href="howItWorks()" class="hover:text-white"
                        >How It Works</Link
                    >
                    <Link :href="pricing()" class="hover:text-white"
                        >Pricing</Link
                    >
            ...
            <div>
                ...
                <div class="mt-4 grid gap-3 text-sm">
                    ...
                    <Link
                        v-if="!config.contact.email && !config.contact.phone"
                        :href="contact()"
